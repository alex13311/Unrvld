    ...
    <header className="sticky top-0 z-50 border-b border-white/10 bg-black/80 backdrop-blur-md">
      <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4">
        ...
        <div className="flex items-center gap-4">
          <Link
            href="/contact"
            className="hidden rounded-full border border-white/25 px-5 py-2 text-xs uppercase tracking-[0.2em] text-white transition hover:bg-white hover:text-black sm:inline-flex"
          >
            Book a Call
          </Link>
            ...
            >
              ...
              <div className="mt-auto">
                <Link
                  href="/contact"
                  onClick={() => setOpen(false)}
                  className="inline-flex rounded-full border border-white/25 px-5 py-3 text-xs uppercase tracking-[0.2em] text-white transition hover:bg-white hover:text-black"
                >
                  Book a Call
                </Link>
              </div>
